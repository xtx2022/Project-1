...
for i in range(len(images)):
    for j in range(len(images[i].cord_of_points)):
        max_val.append(np.sum(extract_subarr(images[i].raw_image, np.round(images[i].cord_of_points[j]).astype(int), 0)))
        sum3.append(np.sum(extract_subarr(images[i].raw_image, np.round(images[i].cord_of_points[j]).astype(int), 1)))
        sum5.append(np.sum(extract_subarr(images[i].raw_image, np.round(images[i].cord_of_points[j]).astype(int), 2)))
...
for i in range(len(images_30)):
    for j in range(len(images_30[i].cord_of_points)):
        max_val.append(np.sum(extract_subarr(images_30[i].raw_image, np.round(images_30[i].cord_of_points[j]).astype(int), 0)))
        sum3.append(np.sum(extract_subarr(images_30[i].raw_image, np.round(images_30[i].cord_of_points[j]).astype(int), 1)))
        sum5.append(np.sum(extract_subarr(images_30[i].raw_image, np.round(images_30[i].cord_of_points[j]).astype(int), 2)))
...
for i in range(len(images_90)):
    for j in range(len(images_90[i].cord_of_points)):
        max_val.append(np.sum(extract_subarr(images_90[i].raw_image, np.round(images_90[i].cord_of_points[j]).astype(int), 0)))
        sum3.append(np.sum(extract_subarr(images_90[i].raw_image, np.round(images_90[i].cord_of_points[j]).astype(int), 1)))
        sum5.append(np.sum(extract_subarr(images_90[i].raw_image, np.round(images_90[i].cord_of_points[j]).astype(int), 2)))
